...
export const Modal = ({children, showModal, style, height="35%"}:{children: any, showModal: any, style?: any, height?: string}) =>{
    ...
    return (
        <View pointerEvents={pointerEventType} style={[{position: 'absolute', zIndex: 99999, height: '100%', width: '100%', backgroundColor: "rgba(0,0,0,0.0)", justifyContent: 'center', alignItems: 'center'}]}>
            <Animated.View style={[showModalStyle, {backgroundColor: 'white', width: "80%", height: height, elevation: 5, borderRadius: 20, flexDirection: 'column', justifyContent: 'space-between'}, style]}>
              {children}
            </Animated.View>
        </View>
    );
